...
const education = [
  ...
  },
  {
    ...
    type: "online",
    description:
      "Deep dive into advanced React patterns, hooks, and state management techniques.",
  },
  {
    ...
    type: "online",
    description:
      "Modern web development with JavaScript, React, Node.js, and GraphQL.",
  },
  {
    ...
    type: "online",
    description:
      "Foundations of computer science and programming using C, Python, SQL, and JavaScript.",
  },
];
